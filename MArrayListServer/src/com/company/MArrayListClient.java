...
//отправить сообщение на сервер
            ArrayList<Double> reqArrayList = new ArrayList<Double>();
            for (int x = 0 ; x < 4 ; x++){
                String number = br.readLine();
                reqArrayList.add(Double.parseDouble(number));
            }


            ObjArray Obj = new ObjArray(reqArrayList, message);
            out.writeObject(Obj);
